 ...
 * @author Sadman
 */
public class cse_2205_sub extends javax.swing.JFrame {

    /**
     * Creates new form cse_2205_sub
     */
       String student_id;
    String xx="Cse 2205";
    String filepath;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cse 2205 Subjective");
    ...
    private void openbuttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_openbuttonMouseClicked
        ...
        {
            database_connection dc=new database_connection();
            ResultSet rs=dc.state.executeQuery("select * from cse_2205_sub where question_no='"+questionid+"'");
            while(rs.next())
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cse_2205_sub.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               // new cse_2205_sub().setVisible(true);
            }
        });
    }
