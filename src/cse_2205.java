 ...
 * @author Sadman
 */
public class cse_2205 extends javax.swing.JFrame {

    /**
     * Creates new form cse_2205
     */
      String student_id;
    String questionid="1";
    String ans;
    ...
    public cse_2205(String a) {
        initComponents();
        this.setLocationRelativeTo(null);
        student_id=a;
        String course="Cse 2205";
        try
        {
             database_connection dc=new database_connection();
        ...
        try{
            database_connection dc=new database_connection();
            ResultSet rs=dc.state.executeQuery("SELECT COUNT(*) AS rowcount FROM cse_2205");
            rs.next();
            c=rs.getString("rowcount");
            int d=Integer.valueOf(c);
            d++;
            c=String.valueOf(d);
            rs=dc.state.executeQuery("select * from cse_2205 where question_no='"+questionid+"'");
            while(rs.next())
            {
        ...
        public void question()
        {
            try{
            database_connection dc=new database_connection();
            ResultSet rs=dc.state.executeQuery("select * from cse_2205 where question_no='"+questionid+"'");
            while(rs.next())
            {
                  idlabel.setText(""+questionid);
                  questionlabel.setText(rs.getString(2));
    ...
    private void submitbuttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submitbuttonMouseClicked
        ...
        try
        {
            ...
            new cse_2205_sub(student_id).setVisible(true);
        }
        catch(Exception e)
        {
            JOptionPane.showMessageDialog(null,e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cse_2205.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
