 ...
 * @author Sadman
 */
public class cse_2201_sub extends javax.swing.JFrame {

    /**
     * Creates new form cse_2201_sub
     */
    String student_id;
    String xx="Cse 2201";
    String filepath;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cse 2201 Subjective");
        ...
        pathtf.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void openbuttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_openbuttonMouseClicked
       try
        {
            database_connection dc=new database_connection();
            ResultSet rs=dc.state.executeQuery("select * from cse_2201_sub where question_no='"+questionid+"'");
            while(rs.next())
            {
    ...
    private void uploadbuttonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_uploadbuttonMouseClicked
         try{
         database_connection dc=new database_connection(); 
         String q = "insert into cse_2201_ans values('"+student_id+"','"+xx+"','"+filepath+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cse_2201_sub.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              // new cse_2201_sub().setVisible(true);
            }
        });
    }
